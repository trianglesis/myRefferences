...
# https://himawari8-dl.nict.go.jp/himawari.asia/img/D531106/1d/550/2020/01/13/000000_0_0.png
# https://himawari8-dl.nict.go.jp/himawari.asia/img/D531106/1d/550/2020/01/13/124000_0_0.png
# '''
...
def dl_img(file_path, file_name, new_data):
    ...
    full_url = url + '/'.join(
        ['{:04d}'.format(new_data['Y']), '{:02d}'.format(new_data['M']), '{:02d}'.format(new_data['D'])]) + \
